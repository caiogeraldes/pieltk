...
- `<https://www.unicode.org/charts/PDF//U102A0.pdf>`_
...
# The i and r used at Hyllarima are not represented as a glyph of their own yet.
HYLLARIMA = [
    "\U000102A0", # 𐊠 a
    "\U000102A2", # 𐊢 d
    "\U000102A3", # 𐊣 l
...
# The β, i, q and z used at Mylasa are not represented as a glyph of their own yet.
MYLASA = [
    "\U000102A0", # 𐊠 a
    "\U000102A2", # 𐊢 d
    "\U000102A3", # 𐊣 l
...
# The ḱ and β used at Stratonikeia are not represented as a glyph of their own yet.
STRATONIKEIA = [
    "\U000102A0", # 𐊠 a
    "\U000102A2", # 𐊢 d
    "\U000102A3", # 𐊣 l
